...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.run(sql`CREATE TABLE \`pages_blocks_hero_video_links\` (
  	\`_order\` integer NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_hero_video_links_order_idx\` ON \`pages_blocks_hero_video_links\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_hero_video_links_parent_id_idx\` ON \`pages_blocks_hero_video_links\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_hero_video_links_locale_idx\` ON \`pages_blocks_hero_video_links\` (\`_locale\`);`)
  ...
  await db.run(sql`CREATE INDEX \`pages_blocks_hero_video_locale_idx\` ON \`pages_blocks_hero_video\` (\`_locale\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_hero_video_poster_idx\` ON \`pages_blocks_hero_video\` (\`poster_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_trust_marquee_items\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`_locale\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`label\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_trust_marquee\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_trust_marquee_items_order_idx\` ON \`pages_blocks_trust_marquee_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_trust_marquee_items_parent_id_idx\` ON \`pages_blocks_trust_marquee_items\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_trust_marquee_items_locale_idx\` ON \`pages_blocks_trust_marquee_items\` (\`_locale\`);`)
  ...
  await db.run(sql`CREATE INDEX \`pages_blocks_trust_marquee_locale_idx\` ON \`pages_blocks_trust_marquee\` (\`_locale\`);`)
  ...
  await db.run(sql`CREATE INDEX \`pages_blocks_product_showcase_locale_idx\` ON \`pages_blocks_product_showcase\` (\`_locale\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_why_grid_items\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`_locale\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	...
  	\`title\` text,
  	\`body\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_why_grid\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_why_grid_items_order_idx\` ON \`pages_blocks_why_grid_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_why_grid_items_parent_id_idx\` ON \`pages_blocks_why_grid_items\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_why_grid_items_locale_idx\` ON \`pages_blocks_why_grid_items\` (\`_locale\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_why_grid\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`_locale\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_why_grid_order_idx\` ON \`pages_blocks_why_grid\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_why_grid_parent_id_idx\` ON \`pages_blocks_why_grid\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_why_grid_path_idx\` ON \`pages_blocks_why_grid\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_why_grid_locale_idx\` ON \`pages_blocks_why_grid\` (\`_locale\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_financing_band\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`_locale\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_financing_band_order_idx\` ON \`pages_blocks_financing_band\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_financing_band_parent_id_idx\` ON \`pages_blocks_financing_band\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_financing_band_path_idx\` ON \`pages_blocks_financing_band\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_financing_band_locale_idx\` ON \`pages_blocks_financing_band\` (\`_locale\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_region_grid_regions\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`_locale\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`name\` text,
  	\`cities\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_region_grid\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_region_grid_regions_order_idx\` ON \`pages_blocks_region_grid_regions\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_region_grid_regions_parent_id_idx\` ON \`pages_blocks_region_grid_regions\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_region_grid_regions_locale_idx\` ON \`pages_blocks_region_grid_regions\` (\`_locale\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_region_grid\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`_locale\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_region_grid_order_idx\` ON \`pages_blocks_region_grid\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_region_grid_parent_id_idx\` ON \`pages_blocks_region_grid\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_region_grid_path_idx\` ON \`pages_blocks_region_grid\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_region_grid_locale_idx\` ON \`pages_blocks_region_grid\` (\`_locale\`);`)
  ...
  await db.run(sql`CREATE INDEX \`pages_blocks_gallery_grid_locale_idx\` ON \`pages_blocks_gallery_grid\` (\`_locale\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_faq_list_items\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`_locale\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`question\` text,
  	\`answer\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_faq_list\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_faq_list_items_order_idx\` ON \`pages_blocks_faq_list_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_faq_list_items_parent_id_idx\` ON \`pages_blocks_faq_list_items\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_faq_list_items_locale_idx\` ON \`pages_blocks_faq_list_items\` (\`_locale\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_faq_list\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`_locale\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_faq_list_order_idx\` ON \`pages_blocks_faq_list\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_faq_list_parent_id_idx\` ON \`pages_blocks_faq_list\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_faq_list_path_idx\` ON \`pages_blocks_faq_list\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_faq_list_locale_idx\` ON \`pages_blocks_faq_list\` (\`_locale\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_hero_video_links\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_locale\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_hero_video_links_order_idx\` ON \`_pages_v_blocks_hero_video_links\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_hero_video_links_parent_id_idx\` ON \`_pages_v_blocks_hero_video_links\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_hero_video_links_locale_idx\` ON \`_pages_v_blocks_hero_video_links\` (\`_locale\`);`)
  ...
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_hero_video_locale_idx\` ON \`_pages_v_blocks_hero_video\` (\`_locale\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_hero_video_poster_idx\` ON \`_pages_v_blocks_hero_video\` (\`poster_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_trust_marquee_items\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_locale\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`label\` text,
  	\`_uuid\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_trust_marquee\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_trust_marquee_items_order_idx\` ON \`_pages_v_blocks_trust_marquee_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_trust_marquee_items_parent_id_idx\` ON \`_pages_v_blocks_trust_marquee_items\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_trust_marquee_items_locale_idx\` ON \`_pages_v_blocks_trust_marquee_items\` (\`_locale\`);`)
  ...
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_trust_marquee_locale_idx\` ON \`_pages_v_blocks_trust_marquee\` (\`_locale\`);`)
  ...
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_product_showcase_locale_idx\` ON \`_pages_v_blocks_product_showcase\` (\`_locale\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_why_grid_items\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_locale\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	...
  	\`body\` text,
  	\`_uuid\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_why_grid\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_why_grid_items_order_idx\` ON \`_pages_v_blocks_why_grid_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_why_grid_items_parent_id_idx\` ON \`_pages_v_blocks_why_grid_items\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_why_grid_items_locale_idx\` ON \`_pages_v_blocks_why_grid_items\` (\`_locale\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_why_grid\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`_locale\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_why_grid_order_idx\` ON \`_pages_v_blocks_why_grid\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_why_grid_parent_id_idx\` ON \`_pages_v_blocks_why_grid\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_why_grid_path_idx\` ON \`_pages_v_blocks_why_grid\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_why_grid_locale_idx\` ON \`_pages_v_blocks_why_grid\` (\`_locale\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_financing_band\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`_locale\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_financing_band_order_idx\` ON \`_pages_v_blocks_financing_band\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_financing_band_parent_id_idx\` ON \`_pages_v_blocks_financing_band\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_financing_band_path_idx\` ON \`_pages_v_blocks_financing_band\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_financing_band_locale_idx\` ON \`_pages_v_blocks_financing_band\` (\`_locale\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_region_grid_regions\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_locale\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	...
  	\`cities\` text,
  	\`_uuid\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_region_grid\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_region_grid_regions_order_idx\` ON \`_pages_v_blocks_region_grid_regions\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_region_grid_regions_parent_id_idx\` ON \`_pages_v_blocks_region_grid_regions\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_region_grid_regions_locale_idx\` ON \`_pages_v_blocks_region_grid_regions\` (\`_locale\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_region_grid\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`_locale\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_region_grid_order_idx\` ON \`_pages_v_blocks_region_grid\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_region_grid_parent_id_idx\` ON \`_pages_v_blocks_region_grid\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_region_grid_path_idx\` ON \`_pages_v_blocks_region_grid\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_region_grid_locale_idx\` ON \`_pages_v_blocks_region_grid\` (\`_locale\`);`)
  ...
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_gallery_grid_locale_idx\` ON \`_pages_v_blocks_gallery_grid\` (\`_locale\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_faq_list_items\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_locale\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	...
  	\`answer\` text,
  	\`_uuid\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_faq_list\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_faq_list_items_order_idx\` ON \`_pages_v_blocks_faq_list_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_faq_list_items_parent_id_idx\` ON \`_pages_v_blocks_faq_list_items\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_faq_list_items_locale_idx\` ON \`_pages_v_blocks_faq_list_items\` (\`_locale\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_faq_list\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`_locale\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_faq_list_order_idx\` ON \`_pages_v_blocks_faq_list\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_faq_list_parent_id_idx\` ON \`_pages_v_blocks_faq_list\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_faq_list_path_idx\` ON \`_pages_v_blocks_faq_list\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_faq_list_locale_idx\` ON \`_pages_v_blocks_faq_list\` (\`_locale\`);`)
  ...
  await db.run(sql`CREATE TABLE \`products_quick_specs\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`products\`(\`id\`) ON UPDATE no action ON DELETE cascade
  ...
  `)
  await db.run(sql`CREATE INDEX \`products_quick_specs_order_idx\` ON \`products_quick_specs\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`products_quick_specs_parent_id_idx\` ON \`products_quick_specs\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`products_quick_specs_locales\` (
  	\`label\` text NOT NULL,
  	\`value\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`_locale\` text NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`products_quick_specs\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE UNIQUE INDEX \`products_quick_specs_locales_locale_parent_id_unique\` ON \`products_quick_specs_locales\` (\`_locale\`,\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`products_full_specs\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`products\`(\`id\`) ON UPDATE no action ON DELETE cascade
  ...
  `)
  await db.run(sql`CREATE INDEX \`products_full_specs_order_idx\` ON \`products_full_specs\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`products_full_specs_parent_id_idx\` ON \`products_full_specs\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`products_full_specs_locales\` (
  	\`label\` text NOT NULL,
  	\`value\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`_locale\` text NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`products_full_specs\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE UNIQUE INDEX \`products_full_specs_locales_locale_parent_id_unique\` ON \`products_full_specs_locales\` (\`_locale\`,\`_parent_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`products_rels\` (
  	...
  	FOREIGN KEY (\`product_options_id\`) REFERENCES \`product_options\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  ...
  await db.run(sql`CREATE INDEX \`products_rels_product_options_id_idx\` ON \`products_rels\` (\`product_options_id\`);`)
  ...
  `)
  await db.run(sql`CREATE UNIQUE INDEX \`product_options_slug_idx\` ON \`product_options\` (\`slug\`);`)
  ...
  await db.run(sql`CREATE TABLE \`product_options_locales\` (
  	\`label\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`_locale\` text NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  ...
  `)
  await db.run(sql`CREATE UNIQUE INDEX \`product_options_locales_locale_parent_id_unique\` ON \`product_options_locales\` (\`_locale\`,\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`product_options_rels\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`order\` integer,
  	\`parent_id\` integer NOT NULL,
  	\`path\` text NOT NULL,
  	\`products_id\` integer,
  	FOREIGN KEY (\`parent_id\`) REFERENCES \`product_options\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`products_id\`) REFERENCES \`products\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`product_options_rels_order_idx\` ON \`product_options_rels\` (\`order\`);`)
  await db.run(sql`CREATE INDEX \`product_options_rels_parent_idx\` ON \`product_options_rels\` (\`parent_id\`);`)
  await db.run(sql`CREATE INDEX \`product_options_rels_path_idx\` ON \`product_options_rels\` (\`path\`);`)
  await db.run(sql`CREATE INDEX \`product_options_rels_products_id_idx\` ON \`product_options_rels\` (\`products_id\`);`)
  await db.run(sql`CREATE TABLE \`colors\` (
  	...
  	\`updated_at\` text DEFAULT (strftime('%Y-%m-%dT%H:%M:%fZ', 'now')) NOT NULL,
  	\`created_at\` text DEFAULT (strftime('%Y-%m-%dT%H:%M:%fZ', 'now')) NOT NULL,
  	FOREIGN KEY (\`swatch_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null
  );
  `)
  await db.run(sql`CREATE UNIQUE INDEX \`colors_slug_idx\` ON \`colors\` (\`slug\`);`)
  await db.run(sql`CREATE INDEX \`colors_swatch_idx\` ON \`colors\` (\`swatch_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`colors_locales\` (
  	\`name\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`_locale\` text NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  ...
  `)
  await db.run(sql`CREATE UNIQUE INDEX \`colors_locales_locale_parent_id_unique\` ON \`colors_locales\` (\`_locale\`,\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`colors_rels\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`order\` integer,
  	\`parent_id\` integer NOT NULL,
  	\`path\` text NOT NULL,
  	\`products_id\` integer,
  	FOREIGN KEY (\`parent_id\`) REFERENCES \`colors\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`products_id\`) REFERENCES \`products\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`colors_rels_order_idx\` ON \`colors_rels\` (\`order\`);`)
  await db.run(sql`CREATE INDEX \`colors_rels_parent_idx\` ON \`colors_rels\` (\`parent_id\`);`)
  await db.run(sql`CREATE INDEX \`colors_rels_path_idx\` ON \`colors_rels\` (\`path\`);`)
  await db.run(sql`CREATE INDEX \`colors_rels_products_id_idx\` ON \`colors_rels\` (\`products_id\`);`)
  await db.run(sql`CREATE TABLE \`locations\` (
  	...
  	\`es_spoken\` integer DEFAULT false,
  	\`published\` integer DEFAULT true,
  	\`updated_at\` text DEFAULT (strftime('%Y-%m-%dT%H:%M:%fZ', 'now')) NOT NULL,
  	\`created_at\` text DEFAULT (strftime('%Y-%m-%dT%H:%M:%fZ', 'now')) NOT NULL,
  ...
  await db.run(sql`CREATE INDEX \`locations_map_image_idx\` ON \`locations\` (\`map_image_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`header\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`phone\` text DEFAULT '877-439-7433',
  	\`updated_at\` text,
  	\`created_at\` text
  );
  `)
  await db.run(sql`CREATE TABLE \`header_locales\` (
  	\`quote_label\` text DEFAULT 'Get a quote',
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`_locale\` text NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`header\`(\`id\`) ON UPDATE no action ON DELETE cascade
  ...
  await db.run(sql`CREATE TABLE \`site_settings\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`phone\` text DEFAULT '877-439-7433' NOT NULL,
  	\`email\` text DEFAULT 'info@superiorsheds.com',
  	\`show_prices\` integer DEFAULT true,
  	\`updated_at\` text,
  	\`created_at\` text
  );
  `)
  await db.run(sql`CREATE TABLE \`site_settings_locales\` (
  	\`hq_title\` text DEFAULT 'Plant & main yard',
  	\`hq_address\` text DEFAULT '2323 S. Volusia Avenue
  Orange City, Florida 32763',
  	\`zip_success_message\` text,
  	\`quote_headline\` text,
  	\`quote_form_note\` text,
  	\`quote_sent_title\` text,
  	\`quote_sent_body\` text,
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  await db.run(sql`DROP TABLE \`pages_blocks_hero_video_links\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_hero_video\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_trust_marquee_items\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_trust_marquee\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_product_showcase\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_why_grid_items\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_why_grid\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_financing_band\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_region_grid_regions\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_region_grid\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_gallery_grid\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_faq_list_items\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_faq_list\`;`)
  ...
  await db.run(sql`DROP TABLE \`_pages_v_blocks_hero_video_links\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_hero_video\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_trust_marquee_items\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_trust_marquee\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_product_showcase\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_why_grid_items\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_why_grid\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_financing_band\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_region_grid_regions\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_region_grid\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_gallery_grid\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_faq_list_items\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_faq_list\`;`)
  ...
  await db.run(sql`DROP TABLE \`products_quick_specs\`;`)
  await db.run(sql`DROP TABLE \`products_quick_specs_locales\`;`)
  await db.run(sql`DROP TABLE \`products_full_specs\`;`)
  await db.run(sql`DROP TABLE \`products_full_specs_locales\`;`)
  ...
  await db.run(sql`DROP TABLE \`product_options_locales\`;`)
  await db.run(sql`DROP TABLE \`product_options_rels\`;`)
  await db.run(sql`DROP TABLE \`colors\`;`)
  await db.run(sql`DROP TABLE \`colors_locales\`;`)
  await db.run(sql`DROP TABLE \`colors_rels\`;`)
